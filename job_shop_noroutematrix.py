...
part_a = OpenClass(model, "Part A", source, Dist.Determ(1))
part_b = OpenClass(model, "Part B", source, Dist.Determ(0.5))
part_c = OpenClass(model, "Part C", source, Dist.Determ(0.8))

# Set services
m1.set_service(part_a, Dist.Determ(1.1))
m1.set_service(part_b, Dist.Determ(1.3))
m1.set_service(part_c, Dist.Determ(1))
m2.set_service(part_a, Dist.Determ(0.9))
m2.set_service(part_b, Dist.Determ(1.2))
m3.set_service(part_b, Dist.Determ(1))
m3.set_service(part_c, Dist.Determ(3))
m4.set_service(part_a, Dist.Determ(1.5))
m5.set_service(part_a, Dist.Determ(0.7))
m5.set_service(part_b, Dist.Determ(0.8))
m5.set_service(part_c, Dist.Determ(0.5))
